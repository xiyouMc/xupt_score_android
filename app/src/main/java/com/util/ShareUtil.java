...
public class ShareUtil {
    ...
    public OnekeyShare showShare() {
        ...
        oks.setTitleUrl("http://www.codemc.top:8080/manager/install.html");
        // text是分享文本，所有平台都需要这个字段
        oks.setText("我正在使用《西邮成绩》查询平时成绩和卷面成绩，还可以查询专业排名奥，你快下载试试吧。下载链接:http://www.codemc.top:8080/manager/install.html");
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        // oks.setImagePath("/sdcard/test.jpg");// 确保SDcard下面存在此张图片
        // url仅在微信（包括好友和朋友圈）中使用
        //oks.setImagePath("http://www.xiyoumobile.com/wechat_app/xiyouscore/");
        oks.setUrl("http://www.codemc.top:8080/manager/install.html");
        // comment是我对这条分享的评论，仅在人人网和QQ空间使用
        oks.setComment("《西邮成绩》分享功能,下载地址:");
        // site是分享此内容的网站名称，仅在QQ空间使用
        oks.setSite(context.getString(R.string.app_name));
        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
        oks.setSiteUrl("http://www.codemc.top:8080/manager/install.html");
        return oks;
    }
